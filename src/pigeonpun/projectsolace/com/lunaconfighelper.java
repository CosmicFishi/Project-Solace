...
public class lunaconfighelper implements LunaSettingsListener {
    ...
    public static void initLunaConfig() {
        ...
        addSetting("ps_bygonedameGenerateSalvage", "boolean", null, projectsolaceplugin.ps_bygonedameGenerateSalvage);
    ...
    public static void loadConfigFromLuna() {
        ...
        projectsolaceplugin.ps_bygonedameGenerateSalvage = (boolean)loadSetting("ps_bygonedameGenerateSalvage", "boolean");
