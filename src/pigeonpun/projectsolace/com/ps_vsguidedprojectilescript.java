 ...
 * @author Nicke535
 */
public class ps_vsguidedprojectilescript extends BaseEveryFrameCombatPlugin {
    ...
    private static final float GUIDANCE_DELAY_MAX = 1f;
     ...
     */
    public ps_vsguidedprojectilescript(@NotNull DamagingProjectileAPI proj, CombatEntityAPI target) {
        this.proj = proj;
        this.target = target;
