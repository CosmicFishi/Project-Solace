...
public class ps_warpingminestats extends BaseShipSystemScript implements MineStrikeStatsAIInfoProvider {
    ...
    public static final Color RING_COLOR_MINE = new Color(164,15,187, 255);
    public static final Color MISSILE_SLOWDOWN_COLOR = new Color(130,255,95,255);
...
//			mine.getDamage().setMultiplier(mine.getDamage().getMultiplier() * extraDamageMult);
        ...
        Global.getCombatEngine().addPlugin(createMissileJitterAndSlowdownPlugin(mine, fadeInTime));
    ...
    protected EveryFrameCombatPlugin createMissileJitterAndSlowdownPlugin(final MissileAPI mine, final float fadeInTime) {
        return new BaseEveryFrameCombatPlugin() {
            ...
            public void advance(float amount, List<InputEventAPI> events) {
                ...
                //slowdown missiles
                List<MissileAPI> missilesNearby = CombatUtils.getMissilesWithinRange(mine.getLocation(), mine.getMineExplosionRange());
