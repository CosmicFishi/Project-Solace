...
public class ps_daemelieffects implements EveryFrameWeaponEffectPlugin, OnFireEffectPlugin {
    ...
    public void onFire(DamagingProjectileAPI projectile, WeaponAPI weapon, CombatEngineAPI engine) {
        ...
        engine.addLayeredRenderingPlugin(new ps_daemeliProjectileCombatPlugin(projectile));
    }
    ...
    public class ps_daemeliProjectileCombatPlugin extends BaseCombatLayeredRenderingPlugin {
        Logger log = Global.getLogger(ps_daemeliProjectileCombatPlugin.class);
        ...
        public ps_daemeliProjectileCombatPlugin(DamagingProjectileAPI proj) {
            this.projectile = proj;
        }
        @Override
        public void render(CombatEngineLayers layer, ViewportAPI viewport) {
            if (Global.getCombatEngine().isPaused()) return;
            if(this.projectile != null && !this.projectile.isExpired() && !this.projectile.isFading()) {
                calcCurrTimeTravel(this.projectile, Global.getCombatEngine().getElapsedInLastFrame());
                calcCurrRadius(this.projectile, this.projectile.getWeapon());
                //start flame out fighter / flame out projectiles
                startTheFun(this.projectile);
                //render ring
                drawCircle(this.projectile);
            }
        }
