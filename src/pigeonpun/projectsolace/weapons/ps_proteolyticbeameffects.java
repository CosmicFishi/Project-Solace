...
public class ps_proteolyticbeameffects implements BeamEffectPlugin {
    ...
    private final IntervalUtil timer = new IntervalUtil(1.85f, 2.85f);
    private final float BEAM_OG_DAMAGE_PERCENTAGE = 10f;
    ...
    public void advance(float amount, CombatEngineAPI engine, BeamAPI beam) {
        ...
        if(beam.getDamageTarget() != null && beam.getDamageTarget() instanceof ShipAPI) {
            if(timer.intervalElapsed()) {
                ...
                engine.spawnEmpArc(beam.getSource(), beamLocation, null, beam.getDamageTarget(), DamageType.ENERGY, damage, 0, 2000f, "ps_proteolyticbeam_emp_impact", MathUtils.getRandomNumberInRange(10, 20), Color.red, Color.white);
            }
...
//                    engine.spawnEmpArc(beam.getSource(), spawnEMPStart, null, beam.getDamageTarget(), DamageType.ENERGY, beam.getDamage().getDamage() * BEAM_OG_DAMAGE_PERCENTAGE / 100, 0, 2000f, "ps_proteolyticbeam_emp_impact", 10f, new Color(140, 58, 255, 255), Color.white);
//                }
//            }
        }
