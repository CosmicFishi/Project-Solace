package pigeonpun.projectsolace.weapons.ai;
...
import pigeonpun.projectsolace.weapons.ps_anaxyreffects;
//MagicMissile my beloved
public class ps_anaxyr_ai implements GuidedMissileAI, MissileAIPlugin {
    ...
    Logger log = Global.getLogger(ps_anaxyr_ai.class);
    ...
    public ps_anaxyr_ai(MissileAPI missile, ShipAPI launchingShip) {
    ...
    public void advance(float amount) {
        ...
        if (target == null
            ...
            ShipAPI missileSeekingTarget = MagicTargeting.pickTarget(
                    MISSILE,
                    seeking,
                    MAX_SEARCH_RANGE,
                    SEARCH_CONE,
            ...
            setTarget(missileSeekingTarget);
